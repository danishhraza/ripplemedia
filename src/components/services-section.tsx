      ...
      <div className="relative w-screen left-1/2 right-1/2 -mx-[50vw] px-6 py-4">
        ...
        >
          {services.map((svc) => (
            <motion.div
              key={svc.key}
              className="snap-center min-w-[85%] sm:min-w-[70%] md:min-w-[420px] min-h-[240px] md:min-h-[280px] bg-white/60 backdrop-blur rounded-3xl border border-secondary shadow-[0_0_0_1px_rgba(0,0,0,0.04)] p-6 md:p-8 relative flex-shrink-0 hover:border-primary transition-colors duration-300"
            ...
            >
              ...
              <motion.img
                src={svc.icon}
                alt=""
                className="absolute bottom-6 right-6 w-18 h-18 object-contain opacity-80"
                animate={{
                  rotate: [-4, 4],
                }}
                transition={{
